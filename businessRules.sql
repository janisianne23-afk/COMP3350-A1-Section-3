...
USE HolidayFun;
-- Resort (needed as FK for Facility)
...
-- Facility types from Business Rules
...
-- Facilities linked to the facility types (same IDs as spec)
...
-- Package offers (assumes some packages exist with IDs 1 and 2)

...
CREATE TABLE Facility (
    ...
    name VARCHAR(100) NOT NULL,
    description VARCHAR(255),  -- Changed from CHAR
    status VARCHAR(255),
...
CREATE TABLE AdvertisedOffer (
    offerId INT PRIMARY KEY NOT NULL,  -- Added NOT NULL
    name VARCHAR(100) NOT NULL,
    description VARCHAR(255),
...
CREATE TABLE Reservation (
    ...
    customerId INT NOT NULL,  -- Fixed case consistency
...
CREATE TABLE Booking (
    ...
    FOREIGN KEY (reservationNo) REFERENCES Reservation(reservationNo)
        ON UPDATE CASCADE
        ON DELETE NO ACTION,  -- FIXED: NO ACTION to break cascade path
